...
def fetch_and_analyze_sentiment(api_key, data_dir):
    """
    Fetches news headlines from MarketAux API, analyzes their sentiment, and saves the results.
    """
...
if __name__ == '__main__':
    # IMPORTANT: Get your free API key from https://www.marketaux.com/
    MARKETAUX_API_KEY = 'HR084l0Ck2EF04063RFy71YzcSjcAH7vpPtjGr1d'
    DATA_DIRECTORY = 'data/raw/sentiment'

    if MARKETAUX_API_KEY == 'YOUR_API_KEY':
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        print("!!! WARNING: MarketAux API Key is not set.               !!!")
        print("!!! The script will fail. Please edit get_sentiment_data.py and !!!")
        print("!!! replace 'YOUR_API_KEY' with your free key.           !!!")
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    else:
